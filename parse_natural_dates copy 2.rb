...
def parse_natural_dates(expression)
  ...
  # create list with noon morning evening afternoon
  ...
  # if noon morning evening afternoon add time
  # time = ""
  # if expression.include?("noon")
  #   time = "12:00"
  # elsif expression.include?("evening")
  #   time = "18:00"
  # elsif expression.include?("afternoon")
  #   time = "14:00"
  # elsif expression.include?("morning")
  #   time = "08:00"
  # end
  # do something fot the next ?? have to kn today
  # date = Date.today
  # date += 1 + ((3-date.wday) % 7)
  # 3 should be dynamic
  # today += 1 + ((3-today.wday) % 7)
